...
FILE_CHECKING_SPACE_CHECK_TOLERANCE = 128 * 1024  # 128kb
...
K_DESCRIPTION: Final[str] = 'description'
...
KENV_EXTRA_DROP_IN_DATABASE_FILES: Final[str] = 'EXTRA_DROP_IN_DATABASE_FILES'
...
# Check status
CHECK_STATUS_UP_TO_DATE: Final[str] = 'UP_TO_DATE'
CHECK_STATUS_UPDATE_AVAILABLE: Final[str] = 'UPDATE_AVAILABLE'
CHECK_STATUS_FAILED: Final[str] = 'FAILED'

# Exit error codes
EXIT_CHECK_SUCCESS: Final[int] = 0
...
EXIT_ERROR_UNINSTALL_EXTERNALS_UNVERIFIED: Final[int] = 22
EXIT_ERROR_UNINSTALL_DRIVE_DISCONNECTED: Final[int] = 23
