...
class OnlineImporterTestBase(unittest.TestCase):
    ...
    def _download_db(self, db, store, inputs, description=None, store_fingerprint=None, db_fingerprint=None):
        return OnlineImporter\
            .from_implicit_inputs(inputs)\
            .add_db(db, store, description, store_fingerprint, db_fingerprint)\
            .download()
