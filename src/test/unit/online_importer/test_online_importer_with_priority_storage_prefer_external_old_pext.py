...
from test.objects_old_pext import empty_test_store, file_nes_smb1, folder_games_nes, media_usb1, config_with, \
    file_s32x_md, \
    ...
    clean_zip_test_fields, fix_old_pext_store
from test.unit.online_importer.online_importer_with_priority_storage_test_base_old_pext import fs_files_smb1_on_usb1, \
    store_smb1_on_usb1, \
    fs_folders_games_on_usb1_usb2_and_fat, fs_folders_nes_on_fat_and_usb1, fs_folders_nes_on_fat_games_on_fat_usb1, \
    OnlineImporterWithPriorityStorageTestBaseOldPext, fs_folders_nes_on_usb1_and_usb2, _store_files_foo, \
...
class TestOnlineImporterWithPriorityStoragePreferExternalOldPext(OnlineImporterWithPriorityStorageTestBaseOldPext):
    ...
    def test_download_zipped_nes_palettes_db___on_empty_setup___downloads_gb_palettes_on_fat(self):
        ...
        self.assertEqual(fix_old_pext_store(store_nes_zipped_palettes_on_fat()), store)
    ...
    def test_download_zipped_nes_palettes_db___on_empty_store_with_games_folder_on_usb1___downloads_gb_palettes_on_usb1(self):
        ...
        self.assertEqual(fix_old_pext_store(store_nes_zipped_palettes_on_usb1()), store)
    ...
    def test_download_palettes_db_from_local_store_pov___on_empty_store_with_empty_fs_usb1___installs_all_in_fs_usb1(self):
        ...
        self.assertEqual(fix_old_pext_store(store_nes_zipped_palettes_on_usb1()), clean_zip_test_fields(store))
        self.assertEqual(fs_data(files=fs_files_nes_palettes_on_usb1(), folders=fs_folders_nes_palettes_on_usb1()), sut.fs_data)
        self.assertReports(sut, [file_nes_palette_a])
