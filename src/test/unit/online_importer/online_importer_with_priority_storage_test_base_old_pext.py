...
from test.zip_objects_old_pext import file_nes_palette_a_descr_zipped, archive_nes_palettes_desc
...
def db_with_zipped_nes_palettes(): return db_entity(
    ...
    zips={archive_nes_palettes_id: archive_nes_palettes_desc()}
)
...
def _store_zips_nes_zipped_palettes(): return {archive_nes_palettes_id: zip_desc("Extracting Palettes", folder_games_nes + '/')}
def _store_files_nes_zipped_palettes(): return {file_nes_palette_a[1:]: {"zip_id": archive_nes_palettes_id, **file_nes_palette_a_descr_zipped()}}


def _store_folders_nes_zipped_palettes(): return {
        folder_games[1:]: {"zip_id": archive_nes_palettes_id},
        folder_games_nes[1:]: {"zip_id": archive_nes_palettes_id},
        folder_games_nes_palettes[1:]: {"zip_id": archive_nes_palettes_id},
    }
