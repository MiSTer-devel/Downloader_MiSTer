...
class TestOnlineImporterDbFetching(unittest.TestCase):
    ...
    def test_load_store_job___always_fails___job_system_gets_ongoing_jobs_cancelled(self):
        ...
        self.assertEqual({
            "job_started": {FetchDataJob.__name__: 1, LoadLocalStoreFingerprintsJob.__name__: 1, LoadLocalStoreJob.__name__: 4, AbortJob.__name__: 1, OpenDbJob.__name__: 1, MixStoreAndDbJob.__name__: 1},
            "job_completed": {AbortJob.__name__: 1, FetchDataJob.__name__: 1, LoadLocalStoreFingerprintsJob.__name__: 1, OpenDbJob.__name__: 1},
