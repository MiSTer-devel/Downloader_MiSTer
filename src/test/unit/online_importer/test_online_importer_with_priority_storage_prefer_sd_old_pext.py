...
from test.objects_old_pext import empty_test_store as empty_test_store_old_pext, \
    store_descr as store_descr_old_pext, media_fat as media_fat_old_pext, file_nes_smb1 as file_nes_smb1_old_pext, \
    ...
    db_id_external_drives_2 as db_id_external_drives_2_old_pext, \
    ...
    store_test_with_file_a_descr as store_test_with_file_a_descr_old_pext, file_a as file_a_old_pext, \
    file_md_sonic as file_md_sonic_old_pext, db_test_with_file_a as db_test_with_file_a_old_pext, \
    db_smb1 as db_smb1_old_pext, db_sonic as db_sonic_old_pext, fix_old_pext_store as fix_old_pext_store_old_pext
from test.unit.online_importer.online_importer_with_priority_storage_test_base_old_pext import \
    ...
    fs_files_smb1_on_usb1 as fs_files_smb1_on_usb1_old_pext, store_smb1_on_usb1 as store_smb1_on_usb1_old_pext, \
    fs_folders_nes_on_usb2 as fs_folders_nes_on_usb2_old_pext, store_smb1_on_usb2 as store_smb1_on_usb2_old_pext, \
    fs_files_smb1_on_usb2 as fs_files_smb1_on_usb2_old_pext, \
    store_smb1_on_usb1_and_usb2 as store_smb1_on_usb1_and_usb2_old_pext, \
    ...
    store_nes_folder_on_usb1 as store_nes_folder_on_usb1_old_pext, fs_folders_nes_on_usb1 as fs_folders_nes_on_usb1_old_pext, \
    fs_folders_games_on_usb1_usb2_and_fat as fs_folders_games_on_usb1_usb2_and_fat_old_pext, \
    store_smb1 as store_smb1_old_pext, fs_files_smb1_on_fat as fs_files_smb1_on_fat_old_pext, \
    ...
    store_smb1_on_fat_and_usb1 as store_smb1_on_fat_and_usb1_old_pext, \
    fs_folders_nes_on_fat_games_on_fat_usb1 as fs_folders_nes_on_fat_games_on_fat_usb1_old_pext, \
    store_smb1_and_contra as store_smb1_and_contra_old_pext, \
    ...
    store_smb1_and_contra_on_fat_and_usb1 as store_smb1_and_contra_on_fat_and_usb1_old_pext, \
    ...
    store_smb1_on_fat_and_smb1_and_contra_on_usb1 as store_smb1_on_fat_and_smb1_and_contra_on_usb1_old_pext, \
    fs_files_smb1_and_contra_on_usb1_smb1_on_fat_too as fs_files_smb1_and_contra_on_usb1_smb1_on_fat_too_old_pext, \
    store_smb1_and_nes_palettes as store_smb1_and_nes_palettes_old_pext, \
    ...
    store_smb1_and_nes_palettes_on_usb1 as store_smb1_and_nes_palettes_on_usb1_old_pext, \
    ...
    store_smb1_on_usb1_and_nes_manual_on_usb2 as store_smb1_on_usb1_and_nes_manual_on_usb2_old_pext, \
    ...
    delme_drive as delme_drive_old_pext, store_smb1_on_delme as store_smb1_on_delme_old_pext, \
    ...
    store_pdfviewer_on_base_system_path_hidden as store_pdfviewer_on_base_system_path_hidden_old_pext, \
    ...
    _store_files_foo as _store_files_foo_old_pext, _store_files_s32x_md as _store_files_s32x_md_old_pext, \
    _store_files_smb1 as _store_files_smb1_old_pext, _store_folders_nes as _store_folders_nes_old_pext, \
    ...
    _store_files_neogeo_md as _store_files_neogeo_md_old_pext, _store_files_contra as _store_files_contra_old_pext, \
    OnlineImporterWithPriorityStorageTestBaseOldPext as OnlineImporterWithPriorityStorageTestBaseOldPext, \
    store_nes_folder as store_nes_folder_old_pext, store_just_nes_palettes_on_usb1 as store_just_nes_palettes_on_usb1_old_pext, \
    fs_files_nes_palettes_on_usb1 as fs_files_nes_palettes_on_usb1_old_pext, \
    store_smb1_on_fat as store_smb1_on_fat_old_pext, fs_files_sonic_on_usb1 as fs_files_sonic_on_usb1_old_pext, \
    store_sonic_on_usb1 as store_sonic_on_usb1_old_pext, \
    store_nes_folder_on_usb1_and_usb2 as store_nes_folder_on_usb1_and_usb2_old_pext
...
class TestOnlineImporterWithPriorityStoragePreferSDOldPext(OnlineImporterWithPriorityStorageTestBaseOldPext):
    def test_download_smb1_db___on_empty_store_with_nes_folder_on_usb1_and_usb2___downloads_smb1_on_usb1(self):
        ...
        self.assertEqual(fix_old_pext_store_old_pext(store_smb1_on_usb1_old_pext()), store)
    ...
    def test_download_smb1_db___after_previous_run___downloads_nothing(self):
        store = store_smb1_on_usb1_old_pext()

        sut = self.download_smb1_db(store, fs(files=fs_files_smb1_on_usb1_old_pext(), folders=fs_folders_nes_on_usb1_and_usb2_old_pext()))

        self.assertEqual(fix_old_pext_store_old_pext(store_smb1_on_usb1_old_pext(), ignore=[file_nes_smb1_old_pext[1:]]), store)
        self.assertEqual(fs_data(files=fs_files_smb1_on_usb1_old_pext(), folders=fs_folders_nes_on_usb1_and_usb2_old_pext()), sut.fs_data)
    ...
    def test_download_empty_db___after_previous_run___removes_files_from_usb1_but_keeps_usb1_and_usb2_folders(self):
        ...
        self.assertEqual(store_nes_folder_on_usb1_old_pext(), store)
    ...
    def test_download_smb1_db___after_previous_run_and_manually_deleting_usb1_folders___downloads_smb1_on_usb2(self):
        ...
        self.assertEqual(fix_old_pext_store_old_pext(store_smb1_on_usb2_old_pext()), store)
    ...
    def test_download_smb1_db___after_copying_files_to_usb1___updates_the_store_with_validated_usb1_and_keeps_usb2(self):
        store = store_smb1_on_usb2_old_pext()
        ...
        self.assertEqual(fix_old_pext_store_old_pext(store_smb1_on_usb1_and_usb2_old_pext(), ignore=[MEDIA_USB2]), store)
    ...
    def test_download_empty_db___after_removing_nes_folders_on_external_drives_with_store_referencing_missing_files___lets_the_store_with_just_games_folders(self):
        store = store_smb1_on_usb1_and_usb2_old_pext()

        sut = self.download_empty_db(store, fs(folders=fs_folders_games_on_usb1_and_usb2_old_pext()))

        self.assertEqual(store_nes_folder_on_usb1_and_usb2_old_pext(), store)
    ...
    def test_download_empty_db___with_folders_installed_on_usb1___keeps_same_store_and_fs(self):
        store = store_nes_folder_on_usb1_old_pext()
    ...
    def test_download_smb1_db___on_empty_store_with_games_folder_on_usb1_usb2_and_fat___downloads_smb1_on_fat(self):
        ...
        self.assertEqual(fix_old_pext_store_old_pext(store_smb1_old_pext()), store)
    ...
    def test_download_smb1_db___after_previous_run___does_nothing(self):
        store = store_smb1_old_pext()

        sut = self.download_smb1_db(store, fs(files=fs_files_smb1_on_fat_old_pext(), folders=fs_folders_nes_on_fat_old_pext()))

        self.assertEqual(fix_old_pext_store_old_pext(store_smb1_old_pext(), ignore=[file_nes_smb1_old_pext[1:]]), store)
        self.assertEqual(fs_data(files=fs_files_smb1_on_fat_old_pext(), folders=fs_folders_nes_on_fat_old_pext()), sut.fs_data)
        self.assertReports(sut, [], save=True)
    ...
    def test_download_smb1_db___after_copying_smb1_to_usb1___just_updates_store_and_validates_smb1_on_usb1(self):
        ...
        self.assertEqual(fix_old_pext_store_old_pext(store_smb1_on_fat_and_usb1_old_pext(), base_path=False), store)
    ...
    def test_download_empty_db___after_copied_smb1_to_usb1___removes_everything_except_games_and_nes_folder_on_usb1(self):
        store = store_smb1_on_fat_and_usb1_old_pext()
    ...
    def test_download_smb1_db___on_empty_setup_and_base_path_delme___installs_smb1_on_delme(self):
        ...
        self.assertEqual(fix_old_pext_store_old_pext(store_smb1_on_delme_old_pext()), store)
    ...
    def test_download_empty_db___after_smb1_was_installed_on_base_path_delme___removes_smb1(self):
        store = store_smb1_on_delme_old_pext()
        ...
        self.assertEqual(empty_store_old_pext(base_path=delme_drive_old_pext), store)
    ...
    def test_download_empty_db___with_smb1_installed_on_delme_and_fat_and_config_with_base_path_delme___removes_smb1_only_on_delme(self):
        ...
        self.assertEqual(empty_store_old_pext(delme_drive_old_pext), store)
    ...
    def test_download_empty_db___with_nes_folder_installed_on_delme_and_fat_and_config_with_base_path_delme___removes_nes_folder_only_on_delme(self):
        store = store_nes_folder_old_pext()
    ...
    def test_download_pdfviewer_db___on_empty_setup_and_base_system_path_hidden___installs_pdfviewer_on_hidden(self):
        ...
        self.assertEqual(fix_old_pext_store_old_pext(store_pdfviewer_on_base_system_path_hidden_old_pext()), store)
    ...
    def test_download_empty_db___after_pdfviewer_was_installed_on_base_system_path_hidden___removes_pdfviewer_and_linux_folder(self):
        store = store_pdfviewer_on_base_system_path_hidden_old_pext()
    ...
    def test_download_smb1_and_contra___on_empty_store_and_nothing_on_fs___downloads_smb1_and_contra_on_fat(self):
        ...
        self.assertEqual(fix_old_pext_store_old_pext(store_smb1_and_contra_old_pext()), store)
    ...
    def test_download_smb1_and_contra___after_previous_run___does_nothing(self):
        store = store_smb1_and_contra_old_pext()
        ...
        self.assertEqual(fix_old_pext_store_old_pext(store_smb1_and_contra_old_pext(), ignore=[file_nes_smb1_old_pext[1:], file_nes_contra_old_pext[1:]]), store)
        self.assertEqual(fs_data(files=fs_files_smb1_and_contra_on_fat_old_pext(), folders=fs_folders_nes_on_fat_old_pext()), sut.fs_data)
        self.assertReports(sut, [], save=True)
    ...
    def test_download_smb1_and_contra___after_copying_contra_to_usb1___downloads_smb_to_usb1_and_validates_contra_on_usb1(self):
        ...
        self.assertEqual(fix_old_pext_store_old_pext(store_smb1_and_contra_on_fat_and_usb1_old_pext(), base_path=False), store)
    ...
    def test_download_empty_db___after_copied_contra_to_usb1___removes_everything_except_nes_folder_on_usb1(self):
        store = store_smb1_and_contra_on_fat_and_usb1_old_pext()
    ...
    def test_download_smb1_and_contra___after_moving_contra_to_usb1___downloads_smb_to_usb1_and_validates_contra_on_usb1(self):
        ...
        self.assertEqual(fix_old_pext_store_old_pext(store_smb1_on_fat_and_smb1_and_contra_on_usb1_old_pext(), base_path=False), store)
    ...
    def test_download_empty_db___after_moved_contra_to_usb1___removes_everything_except_games_and_nes_folder_on_usb1(self):
        store = store_smb1_on_fat_and_smb1_and_contra_on_usb1_old_pext()
    ...
    def test_download_smb1_and_nes_palettes___on_empty_setup___installs_smb1_and_nes_palettes_on_fat(self):
        ...
        self.assertEqual(fix_old_pext_store_old_pext(store_smb1_and_nes_palettes_old_pext()), store)
    ...
    def test_download_empty_db___after_installing_smb1_and_nes_on_fat___removes_everything(self):
        store = store_smb1_and_nes_palettes_old_pext()
    ...
    def test_download_smb1_and_nes_palettes___on_empty_store_with_nes_folder_on_usb1___installs_smb1_and_nes_palettes_on_usb1(self):
        ...
        self.assertEqual(fix_old_pext_store_old_pext(store_smb1_and_nes_palettes_on_usb1_old_pext()), store)
    ...
    def test_download_empty_db___after_installing_smb1_and_nes_on_usb1___removes_everything_except_nes_folder_on_usb1(self):
        store = store_smb1_and_nes_palettes_on_usb1_old_pext()
    ...
    def test_download_smb1_in_db_test_and_nes_manual_in_db_demo___on_empty_stores_with_games_nes_folder_on_usb1_and_docs_nes_folder_on_usb2___installs_smb1_on_usb1_and_nes_manual_on_usb2(self):
        ...
        self.assertEqual({store_id: fix_old_pext_store_old_pext(store) for store_id, store in store_smb1_on_usb1_and_nes_manual_on_usb2_old_pext().items()}, local_store_dbs)
    ...
    def test_download_external_drives_1_and_2___on_empty_stores_with_same_fs_as_system_tests___installs_at_expected_locations(self):
        ...
        self.assertEqual({
            db_id_external_drives_1_old_pext: fix_old_pext_store_old_pext(store_descr_old_pext(
            ...
            db_id_external_drives_2_old_pext: fix_old_pext_store_old_pext(store_descr_old_pext(
                db_id=db_id_external_drives_2_old_pext,
                files_usb0=_store_files_neogeo_md_old_pext(), folders_usb0=_store_folders_docs_neogeo_old_pext(),
    ...
    def test_download_just_nes_palette_file_db___after_installing_smb1_and_nes_palettes_on_usb1___removes_everything_except_nes_palettes_on_usb1(self):
        ...
        self.assertEqual(store_just_nes_palettes_on_usb1_old_pext(), store)
    ...
    def test_download_just_smb1_file_db___with_smb1_and_contra_on_fat_and_usb1___removes_contra_and_keeps_smb1_on_fat_and_usb1_with_its_folders(self):
        ...
        self.assertEqual(store_smb1_on_fat_and_usb1_old_pext(), store)
        self.assertEqual(fs_data(files=fs_files_smb1_on_fat_and_usb1_old_pext(), folders=fs_folders_nes_on_fat_and_usb1_old_pext()), sut.fs_data)
        self.assertReports(sut, [])
    ...
    def test_delme_download_three_dbs_with_sd_priority_files___on_empty_system_with_some_folders____installs_all_in_fat_except_md(self):
        ...
        self.assertSystem({
            ...
            "stores": [fix_old_pext_store_old_pext(store) for store in installed_three_dbs_store()],
    ...
    def test_delme_download_three_dbs_with_sd_priority_files___on_second_run____doesnt_save_anything(self):
        ...
        self.assertSystem({
            "fs": fs_data(files=installed_three_dbs_fs_files(), folders=installed_three_dbs_fs_folders()),
            "stores": [fix_old_pext_store_old_pext(store, ignore=[file_nes_smb1_old_pext[1:], file_md_sonic_old_pext[1:]]) for store in installed_three_dbs_store()],
            "save": True,
        }, sut, stores)
...
def installed_three_dbs_store(): return [store_test_with_file_a_descr_old_pext(), store_smb1_on_fat_old_pext(), store_sonic_on_usb1_old_pext()]
